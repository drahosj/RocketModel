...
extern "C" {
    ...
    int32_t gps_fixed_to_deg_ipart(int32_t fixed);
    int32_t gps_fixed_to_deg_fpart(int32_t fixed, int32_t fbase);

    /* NMEA Format DDMM.mmm...
     * Converts an integer of N mmm fractional minutes
     * to fixed-point decimal degree format.
     */
